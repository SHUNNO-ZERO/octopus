...
const Footer = () => {
    return (
         <>
            <footer className="footer footer-center bg-base-100 text-primary-content">
  <div>
    ...
    <p className="font-bold">
       O C T O P U S  <br/>Providing reliable tech since 2455
    </p> 
   <h1> ei design ta ki footer hisabe chole ? 
